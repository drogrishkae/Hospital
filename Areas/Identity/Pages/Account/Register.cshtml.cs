...
namespace WebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<WebApp.Models.Member> _userStore;
        private readonly IUserEmailStore<WebApp.Models.Member> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<WebApp.Models.Member> userManager,
            IUserStore<WebApp.Models.Member> userStore,
        ...
        private WebApp.Models.Member CreateUser()
        {
            try
            {
                return Activator.CreateInstance<WebApp.Models.Member>();
            }
            catch
            {
        ...
        private IUserEmailStore<WebApp.Models.Member> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<WebApp.Models.Member>)_userStore;
        }
    }
}
